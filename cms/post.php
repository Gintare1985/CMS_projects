...
if(isset($_POST['liked'])){
	...
	//2 Update posts table incrementing with likes
...
?>
	...
	<?php } else { ?>
		...
		<div class="row">
			<p class="pull-right login-to-post">You need to <a href="login.php">Login</a> to like this post</p>
		</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.like').click(function(){
			$.ajax({
				url: "/php/demo/cms/post.php?p_id=<?php echo $the_post_id; ?>",
				type: 'post',
				data: {
					'liked': 1,
					'post_id': post_id,
